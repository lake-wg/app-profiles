...
The CBOR map encoding an EDHOC_Application_Profile object MUST include the element "app_prof" defined in this document, as well as the elements "methods" and "cred_types".
